...
GENERATED="${GOPATH}/src/gitlab.com/distributed_lab/acs/identity-svc/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/distributed_lab/acs/identity-svc/docs/web_deploy"
